            ...
            <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
              <div className="mb-10 w-full">
                ...
                <p className="mb-7 text-base text-body-color dark:text-dark-6">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Nisi qui quos non nihil culpa nam nesciunt consectetur veniam repudiandae 
                  voluptatibus aspernatur libero, error quaerat quasi porro, nemo delectus, maxime blanditiis!
                </p>
